		<!-- Gifts registry -->
		<section id="gifts-registry" class="gifts-registry gr-img-block text-center">
			<div class="container">
				...
				<div class="row indent-bottom">
					<div class="col-xs-12 col-sm-4 indent-bottom-sm">
						<a href="#">
							<img src="img/gifts/amazon.png" alt="">
						</a>
					</div>
					<div class="col-xs-12 col-sm-4 indent-bottom-sm">
						<a href="#">
							<img src="img/gifts/belk.png" alt="">
						</a>
					</div>
					<div class="col-xs-12 col-sm-4 indent-bottom-sm">
						<a href="#">
							<img src="img/gifts/beyond.png" alt="">
						</a>
					</div>
				</div>
				<div class="row">
